          ...
          <div className="container">
            <div className="row">
              <div className="welcome">
                <h2 className="welcome-title">Welcome To Our Health Care Clinic</h2>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-4 col-sm-6 col-xs-12">
                <div className="hservice">
                  <div className="service-img">
                    <img className="img-responsive center-block" src="assets/img/service1.jpg" alt="" />
                  </div>
                  <div className="service-description text-center">
                    ...
                    <a href="#" className="rm-btn btn btn-primary">
                      Read More <i className="fa fa-caret-right" /></a>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-sm-6 col-xs-12">
                <div className="hservice">
                  <div className="service-img">
                    <img className="img-responsive center-block" src="assets/img/service2.jpg" alt="" />
                  </div>
                  <div className="service-description text-center">
              ...
              <div className="col-lg-4 col-sm-6 col-xs-12">
                <div className="hservice">
                  <div className="service-img">
                    <img className="img-responsive center-block" src="assets/img/service3.jpg" alt="" />
                  </div>
                  <div className="service-description text-center">
              ...
              <div className="col-lg-4 col-sm-6 col-xs-12">
                <div className="hservice">
                  <div className="service-img">
                    <img className="img-responsive center-block" src="assets/img/service4.jpg" alt="" />
                  </div>
                  <div className="service-description text-center">
              ...
              <div className="col-lg-4 col-sm-6 col-xs-12">
                <div className="hservice">
                  <div className="service-img">
                    <img className="img-responsive center-block" src="assets/img/service5.jpg" alt="" />
                  </div>
                  <div className="service-description text-center">
              ...
              <div className="col-lg-4 col-sm-6 col-xs-12">
                <div className="hservice">
                  <div className="service-img">
                    <img className="img-responsive center-block" src="assets/img/service6.jpg" alt="" />
                  </div>
                  <div className="service-description text-center">
                          ...
                          <div className="item">
                            <div className="row">
                              ...
                              <div className="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-6 col-xs-offset-3">
                                <img className="img-circle img-responsive center-block" src="assets/img/client3.jpg" alt="Image" />
                              </div>	
                            </div>
                        ...
                        <div id="client-speech">
                          <div className="item">
                            <div className="row">
                              ...
                              <div className="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-6 col-xs-offset-3">
                                <img className="img-circle img-responsive center-block" src="assets/img/client1.jpg" alt="Image" />
                              </div>	
                            </div>
                            <div className="row text-center">
                        ...
                        <div id="client-speech">
                          <div className="item">
                            <div className="row">
                              ...
                              <div className="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-6 col-xs-offset-3">
                                <img className="img-circle img-responsive center-block" src="assets/img/client4.jpg" alt="Image" />
                              </div>	
                            </div>
                            <div className="row text-center">
